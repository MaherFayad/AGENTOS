...
| REQ-DS-98 | PART I | `RailLabel` — vertical via `writing-mode`, +0.45em, `--ink-3`, logical spacing | `apps/web/src/components/primitives/RailLabel.tsx` | `apps/web/src/components/primitives/RailLabel.test.tsx` |
